...
window.Canvate = function(element) {
    ...
    // ::: CLIP TEXT ::: //
    var ClipText = function(text, size, font, color, width, height, interline, textAlign){
        'use strict';
        var _self             = this;
		var LEFT              = "left";
		var CENTER            = "center";
    ...
    var Clip = function (image){
        ...
        // CLIP TEXT
        this.setText = function(text, size, font, color, width, height, interline, textAlign){
            ...
            var clipText = new ClipText(text, size, font, color, width, height, interline, textAlign);
